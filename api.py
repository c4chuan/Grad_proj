...
parser.add_argument("-dr", "--default_refer_path", type=str, default="/home/yjfeng/projects/GPT-SoVITS/backend/sample.wav", help="默认参考音频路径")
parser.add_argument("-dt", "--default_refer_text", type=str, default="你好，我是信云智联大模型，我的工作是确保工厂流程安全", help="默认参考音频文本")
